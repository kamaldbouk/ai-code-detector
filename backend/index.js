...
async function detectAIwithOpenAI(code) {
  ...
  const prompt = `Is the following code snippet likely AI-generated or human-written? Reply with a number between 0 and 100 ONLY, do not add anything to the message, that number represents the percentage of the code that is AI generated. Take into consideration the following: 1. The amount of comments found in the code 2. Check for tags like "Generated by ..." 3. Grammar mistakes in comments and in variable names 4. Lack of human touch as in inconcistincies in variable naming 
  Code: ${snippet}`;
